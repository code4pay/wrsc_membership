...
{{ csrf_field() }}
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="first_name" name="first_name"  value="{{ $user->name }}" placeholder="First Name" type="text" class="form-control" aria-describedby="first_nameHelpBlock" required="required"> 

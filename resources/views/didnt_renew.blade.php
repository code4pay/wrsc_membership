...
<head>
    ...
    <title>WRSC Membership Cancellation</title>
</head>

<body>
    <div class="container-fluid-md">
        <div class="jumbotron col-md-6 offset-md-3 ">
            <h1 class="display-4">Membership Cancelled</h1>
            <p class="lead ">Thank you, Your request for membership cancellation has been processed</p>
            <hr class="my-4">

...
<body>
  <div class="container-fluid-md">
    <div class="jumbotron col-md-6 offset-md-3 alert-success" style="margin-top:1em">
      <h1 class="display-4">Membership Application</h1>
      <p class="lead ">Thank You for application {{$user->first_name}}!</p>
      @if ($user->totalApplicationAmount() > 0 && !$user->primary_member_id)
      <p class="lead ">Your application will be confirmed once your payment has been recieved.</p>
      @endif
      <hr class="my-4">
      <p>IF YOU HAVE ANY QUESTIONS ABOUT YOUR APPLICATION , EMAIL <a href="mailto:membership@wildlife-rescue.org.au">membership@wildlife-rescue.org.au</a> OR
    ...
    <form class="col-md-6 offset-md-3" method="POST">
      ...
      <div class="row">
        <table class="table">
          ...
          <tr>
            ...
            <td>${{Config::get('app.application_fee')}}
          <tr>
            <td></td>
            <td><strong>Total:</strong></td>
            <td><strong>${{$user->totalApplicationAmount()}}</strong></td>
          </tr>
        </table>
      </div>
      ...
      <div class="row alert alert-success">
        <ul>
          ...
          <li>Reference: "{{$user->member_number}}  {{$user->last_name}}"" </li>
      ...
      <div class="row alert alert-warning">
        <ul>
          ...
          <li> (made payable to Wildlife Rescue South Coast Inc) and post together with your name and membership number: {{$user->member_number}} to PO Box 666, NOWRA NSW 2541</li>
